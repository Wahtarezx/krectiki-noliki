class Board:
    ...
    def end_the_game(self):
        if self.cells_list[0].symb == self.cells_list[1].symb and self.cells_list[0].symb == self.cells_list[2].symb\
                and self.cells_list[0].busy == 'y':
            return True

        elif self.cells_list[3].symb == self.cells_list[4].symb == self.cells_list[5].symb\
                and self.cells_list[3].busy == 'y':
            return True

        elif self.cells_list[6].symb == self.cells_list[7].symb == self.cells_list[8].symb\
                and self.cells_list[6].busy == 'y':
            return True

        elif self.cells_list[0].symb == self.cells_list[3].symb == self.cells_list[6].symb\
                and self.cells_list[0].busy == 'y':
            return True

        elif self.cells_list[1].symb == self.cells_list[4].symb == self.cells_list[7].symb\
                and self.cells_list[1].busy == 'y':
            return True

        elif self.cells_list[2].symb == self.cells_list[5].symb == self.cells_list[8].symb\
                and self.cells_list[2].busy == 'y':
            return True

        elif self.cells_list[0].symb == self.cells_list[4].symb == self.cells_list[8].symb\
                and self.cells_list[0].busy == 'y':
            return True

        elif self.cells_list[2].symb == self.cells_list[4].symb == self.cells_list[6].symb\
                and self.cells_list[2].busy == 'y':
            return True
